    ...
    if (isValid) {
      ...
      try {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(backgroundColor: Colors.red, content: Text(error.message ?? "Autenticação falhou.")));
      }
    }
  }
                    ...
                    TextFormField(
                        ...
                        decoration: InputDecoration(
                            ...
                            suffixIcon: IconButton(
                                ...
                                icon: Icon(_passwordConfirmVisivel ? Icons.visibility : Icons.visibility_off,
                    ...
                    Align(
                      ...
                      child: TextButton(
                        ...
                        child: const Text.rich(
                          TextSpan(
                            children: [
                              TextSpan(text: 'Já tem uma conta?', style: TextStyle(color: Colors.black, fontSize: 18)),
                              TextSpan(
                                  text: ' Login',
                                  style: TextStyle(
