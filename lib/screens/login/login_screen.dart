...
import 'package:gestao_de_imobiliaria_mobile/database/controllers/login_controller.dart';
                        ...
                        child: ElevatedButton(
                          onPressed: () async{
                            if (_formKey.currentState!.validate()){
                              ...
                              var password = controller.passwordController.text.trim();
                              LoginController.instance.emailAndPasswordSigIn(email, password);
